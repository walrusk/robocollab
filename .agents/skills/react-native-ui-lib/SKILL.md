...
description: >
  Use `react-native-ui-lib` modifiers for basic styling of
  View and Text. We import View and Text from `@/components/ui` but
  they are the basic View/Text from `react-native-ui-lib`.
