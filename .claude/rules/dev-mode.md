...
1. Run `.ai/scripts/git.sh start`. It reports whether we are on `main`/`develop` and ready for a new plan. If it reports you are still on a plan branch, switch to FOLLOWUP mode and follow those rules instead.
